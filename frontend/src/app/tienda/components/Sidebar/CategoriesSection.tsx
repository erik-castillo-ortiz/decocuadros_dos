...
//           activeCategories.includes(category.categoryId) ||
//           activeCategoryId === category.categoryId ||
//           isParentCategoryExpanded(category)
//             ? ''
//             : 'collapsed'
//         }`}
//       >
...
//   const isParentCategoryExpanded = (category: Category): boolean => {
//     if (!category.subcategories) return false;
//     return category.subcategories.some(
//       (subcategory) =>
//         activeCategories.includes(subcategory.categoryId) ||
//         activeCategoryId === subcategory.categoryId ||
//         isParentCategoryExpanded(subcategory)
//     );
//   };
...
//       >
//         <Link
//           href={category.fullPath || buildCategoryPath(category)}
//           className={`category-link ${
//             activeCategoryId === category.categoryId
//               ? 'category-link--active'
//               : ''
