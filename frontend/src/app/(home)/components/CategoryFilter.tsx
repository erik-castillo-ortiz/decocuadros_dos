...
import productsData from '@/app/helpers/products2.json';
import categoryFilterData from '@/app/helpers/CategoryFilter.json';
...
const CategoryFilter = () => {
  ...
  return (
    <>
      <div
        className="category-filter-section bg-gray appear-animate animated fadeInUpShorter appear-animation-visible"
